...
function main() {
    return __awaiter(this, void 0, void 0, function () {
        var databaseUrl, client, sqlPath, sql, statements, _i, statements_1, statement;
        return __generator(this, function (_a) {
            switch (_a.label) {
                ...
                case 1:
                    _a.sent();
                    sqlPath = path.join(__dirname, 'recreate-casbin-rule.sql');
                    sql = fs.readFileSync(sqlPath, 'utf-8');
                    statements = sql
                        .split(';')
                        .map(function (statement) { return statement.trim(); })
                        .filter(function (statement) { return statement.length > 0 && !statement.startsWith('--'); });
                    _a.label = 2;
                case 2:
                    _a.trys.push([2, , 7, 9]);
                ...
                case 3:
                    ...
                    console.log("Executing: ".concat(statement.split('\n')[0], "..."));
